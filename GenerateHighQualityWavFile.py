...
class Gen():
    ...
    def Generate(self):
        ...
        self.save_wav("outputHighQuality.wav")
    ...
    def Set_led(self,SampleLeds): 
        ...
        for root, _dirs, files in os.walk('.'):
            for name in files:
                if fnmatch.fnmatch(name, "outputHighQuality.wav"):
                    paths.append(os.path.join(root, name))
        
        
        
        if len(paths)>0:
            SampleLeds.Gen_highquality_audio.led.canvas.itemconfig(SampleLeds.Gen_highquality_audio.led.circle, fill="green") 
